...
type ITagDo interface {
	...
	FilterWithNameAndRole(name string, role string) (result []model.Tag, err error)
}

// SELECT * FROM @@table WHERE name = @name{{if role !=""}} AND role = @role{{end}}
func (t tagDo) FilterWithNameAndRole(name string, role string) (result []model.Tag, err error) {
